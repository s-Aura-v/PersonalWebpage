...
import {Webpages} from "../components/Webpages.jsx";
            ...
            <div className="library-container">
                <div className="tabs">
                    <ul className="tabs-list">
                        ...
                        <li onClick={() => setLibraryState(3)}>WEBPAGES</li>
                    </ul>
                </div>
                ...
                {libraryState === 3 && <Webpages/>} {/* Only render MovieLibrary if libraryState is 1 */}
            </div>
        </>
    );
}
